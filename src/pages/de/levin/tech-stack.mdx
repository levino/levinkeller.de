...
Als Mathematiker schätze ich die Klarheit und Vorhersagbarkeit funktionalen Codes. Ich nutze gerne **[effect-ts](https://effect.website/)** für robuste, typsichere Anwendungen mit Railway Oriented Programming. Dieser Ansatz macht Error Handling explizit und Code wartbar.

### Datenbanken und Backend

Für Backend-Lösungen ist meine erste Wahl **[Pocketbase](https://pocketbase.io/)**. Die Kombination aus Einfachheit, Performance und eingebauter Authentifizierung macht es zur idealen Wahl für viele Projekte. Bei direkter Datenbankarbeit arbeite ich mit SQL und Migrations, aber ohne ORM-Frameworks. ORMs versuchen, Komplexität zu verstecken, die man besser explizit handhabt.
...
- **Docker**: Container in **[Coolify](https://coolify.io/)** für volle Kontrolle und Kosteneffizienz
...
Gute Dokumentation spart Zeit und Nerven. Für schnelle Lösungen nutze ich gerne **Docusaurus**, für komplexere Anforderungen **[shipyard](https://github.com/levino/shipyard)**. Wichtig ist mir dabei: Dokumentation muss versioniert und gemeinsam mit dem Code entwickelt werden.
...
Meteor, Next.js, Gatsby, React Native, Redux, Redux-Saga, web3, [ramda](https://ramdajs.com/), [sanctuary](https://sanctuary.js.org/), [fp-ts](https://gcanti.github.io/fp-ts/)
