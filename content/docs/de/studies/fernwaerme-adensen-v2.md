# Case Study: Fernwärmenetz Adensen - Recherche eines kommunalen Verwaltungsvorgangs (v2)
...
<div class="alert alert-info">
  ...
  <div>
    ...
    <p><strong>Version 2:</strong> Aktualisiert am 13.10.2025 - Alle Informationen wurden über die OPARL-Schnittstelle verifiziert und auf den neuesten Stand gebracht.</p>
  </div>
</div>

## Chronologie des Verwaltungsvorgangs

Am 25. März 2025 legte die Verwaltung dem Rat eine Mitteilungsvorlage zum Sachstand der kommunalen Wärmeplanung vor ([DS 12/2025, PDF](/assets/nordstemmen/fernwaerme-adensen/DS_12_2025/Mitteilungsvorlage_DS_12-2025.pdf)). Dies war die erste dokumentierte Befassung mit dem Thema in 2025. Die kommunale Wärmeplanung ist durch das Gebäudeenergiegesetz (GEG) und das Wärmeplanungsgesetz für Kommunen vorgegeben.

Am 24. Juni 2025 beschloss der Rat einen Gestattungsvertrag über die Verlegung und den Betrieb von Wärmeleitungen ([DS 53/2025, PDF](/assets/nordstemmen/fernwaerme-adensen/DS_53_2025/Beschlussvorlage_DS_53-2025.pdf)). Der Beschluss erfolgte einstimmig bei einer Enthaltung. Vertragspartner ist die **Energiegenossenschaft Adensen-Hallerburg e.G.**, die ein Wärmenetz in den Ortschaften Adensen und Hallerburg aufbauen will. Das Projekt nutzt Abwärme aus zwei örtlichen Biogasanlagen (A.H. Energie GmbH & Co. KG und Bioenergie Adensen GmbH & Co. KG) zur Versorgung von öffentlichen und gewerblichen Einrichtungen sowie Privathäusern.

Die Gemeinde erhält als Nutzungsentgelt **0,00025 Euro pro gelieferte Kilowattstunde** (0,025 Cent/kWh). Bei prognostizierten Erträgen von ca. 1.500 Euro pro Jahr entspricht dies einer jährlichen Wärmemenge von 6 Millionen kWh. Der [Gestattungsvertrag (PDF)](/assets/nordstemmen/fernwaerme-adensen/DS_53_2025/Anlage_1_Gestattungsvertrag.pdf) regelt die Rechte und Pflichten. Ein [Lageplan (PDF)](/assets/nordstemmen/fernwaerme-adensen/DS_53_2025/Anlage_2_Lageplan.pdf) zeigt die geplante Trassenführung.
...
Die vorliegende Version 2 wurde am 13.10.2025 erstellt und verifiziert alle Informationen über die OPARL-API. Alle Daten wurden auf Aktualität geprüft und mit dem aktuellen Stand in der Ratsinformationssystem-Datenbank abgeglichen.

## Methodologie: Wie die Daten recherchiert wurden

### Zugang zu kommunalen Daten via OParl
...
- **Organizations** (Gremien): `/body/1/organization`

#### 2. Die Ratssitzung finden
...
- **Web-URL:** https://nordstemmen.ratsinfomanagement.net/tops/?__=UGhVM0hpd2NXNFdFcExjZWZXVqmIMQTxK3_bqsS4QZM

#### 3. Tagesordnungspunkt identifizieren
...
#### 4. Vorlage über Paper-API finden
...
- **Datum:** 16.09.2025
- **Letzte Änderung laut API:** 30.09.2025

## Der Verwaltungsvorgang im Detail
...
## Kontext: Kommunale Wärmeplanung
...
1. **Zeitliche Nähe:** Am 02.10.2025 wurde DS 80/2025 "Anhörung zum Haushaltsplan 2026 und zum Investitionsprogramm bis 2029 für die Ortschaft Adensen" erstellt
2. **Thematische Verbindung:** Die GmbH-Gründung für Wärmeversorgung erfolgt zeitgleich mit Haushaltsplanungen für Adensen
3. **Projektname:** Die "Wärmenetz Adensen GmbH" trägt den Namen der Ortschaft

### Bestätigung

Die geplante GmbH für Wärmeversorgung wird das Fernwärmenetz in Adensen und Hallerburg betreiben. Die Energiegenossenschaft Adensen-Hallerburg e.G. ist Initiator und wird Minderheitsgesellschafter der neu zu gründenden "Wärmenetz Adensen GmbH".

## Antragsteller und Initiatoren

### Federführung

**Innere Dienste und Finanzen** - dies ist die federführende Verwaltungseinheit.

### Ursprünglicher Antragsteller
...
## Learnings: Arbeiten mit der OParl-API

### Best Practices

1. **Pagination beachten:** Neueste Daten sind oft auf den letzten Seiten
2. **Mehrere Endpunkte nutzen:** Papers, Meetings und AgendaItems ergänzen sich
3. **IDs verfolgen:** Consultations verbinden Papers mit Meetings und AgendaItems
4. **Web-URLs nutzen:** Wenn PDF-Parsing schwierig ist, sind die Web-Ansichten oft hilfreicher
5. **Aktualität prüfen:** Das Feld `modified` zeigt die letzte Änderung eines Dokuments

### Einschränkungen

1. **PDF-Zugang:** Die PDFs sind zwar über die API abrufbar, aber nicht immer maschinenlesbar
2. **Fehlende Metadaten:** Nicht alle OParl-Felder werden befüllt (z.B. Originators)
3. **Chronologische Sortierung:** Erschwert das Finden aktueller Vorgänge
4. **Verzögerungen:** Beschlüsse und Protokolle können zeitverzögert in die API eingestellt werden

### Technische Details

**API-Version:** OParl 1.1
**System:** SD.NET RIM 25.2.0
**Vendor:** https://www.sitzungsdienst.net/
**Verifiziert am:** 13.10.2025
...
- Beschlussergebnis (OParl: `result` im AgendaItem)
- Möglicherweise ein Beschlusstext (`resolutionText`)
...
- OParl-API der Gemeinde Nordstemmen: https://nordstemmen.ratsinfomanagement.net/webservice/oparl/v1.1/
- Ratsinformationssystem: https://nordstemmen.ratsinfomanagement.net/

---

_Diese Case Study wurde erstmalig am 10.10.2025 erstellt und als Version 2 am 13.10.2025 über die OPARL-API aktualisiert und verifiziert. Stand: vor der entscheidenden Ratssitzung am 14.10.2025._
